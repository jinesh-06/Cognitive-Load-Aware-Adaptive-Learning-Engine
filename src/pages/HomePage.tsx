...
import { ArrowRight, BookOpen, Brain, CheckCircle2, Cpu, Database, FileText, Layers, RefreshCw, ShieldAlert, Sparkles, TrendingUp, Users, Zap } from 'lucide-react';
...
export const HomePage: React.FC<Props> = ({ onStartLearning, currentLoad, onOpenDisclaimer }) => {
  return (
    <div className="space-y-12 pb-16 animate-fade-in" id="home-page-container">
      {/* Hero Section */}
        ...
        <div className="relative z-10 max-w-3xl space-y-6">
          ...
          <div className="flex flex-wrap items-center gap-4 pt-2">
            <button
              ...
              className="px-6 py-3.5 bg-indigo-600 hover:bg-indigo-500 text-white text-sm font-bold rounded-xl shadow-lg shadow-indigo-600/30 flex items-center gap-2 transition-all transform hover:-translate-y-0.5 active:scale-95"
            ...
            <button
              ...
              className="px-5 py-3.5 bg-slate-800/90 hover:bg-slate-700/90 text-slate-200 border border-slate-700 text-sm font-medium rounded-xl transition-colors"
