...
export const QuizHistoryPage = ({
  ...
  const handleExplainConcept = async (questionItem) => {
  ...
  return (
    <div className="space-y-8 pb-12" id="quiz-history-page">
      {/* Top Banner */}
      ...
      <div className="bg-white rounded-3xl p-6 sm:p-8 border border-slate-200/90 shadow-sm space-y-6" id="weak-question-analysis-section">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-4 border-b border-slate-100">
          ...
          <button
            onClick={() => loadData()}
            className="self-start sm:self-auto px-3.5 py-2 text-xs font-semibold text-slate-700 bg-slate-100 hover:bg-slate-200 rounded-xl transition-colors flex items-center gap-1.5 cursor-pointer"
        ...
        {weakAnalysis?.hasSufficientData && mostDifficult ? (
          <div className="bg-gradient-to-br from-amber-50/70 via-orange-50/40 to-slate-50 border-2 border-amber-200/80 rounded-2xl p-6 sm:p-7 shadow-sm space-y-5">
            ...
            <div className="pt-3 border-t border-amber-200/60 flex flex-wrap items-center justify-between gap-4">
              ...
              <div className="flex items-center gap-3">
                <button
                  ...
                  className="px-5 py-3 bg-gradient-to-r from-indigo-600 to-indigo-700 hover:from-indigo-500 hover:to-indigo-600 text-white font-bold text-xs sm:text-sm rounded-xl shadow-md shadow-indigo-600/20 flex items-center gap-2 transition-all transform hover:-translate-y-0.5 active:scale-95 disabled:opacity-50 cursor-pointer"
                >
                ...
                <button
                  ...
                  className="px-4 py-3 bg-white hover:bg-slate-50 text-slate-700 border border-slate-300 font-semibold text-xs rounded-xl transition-colors flex items-center gap-1.5 shadow-sm cursor-pointer"
                >
            ...
            {explanationResult && (
              <div className="mt-4 p-5 sm:p-6 bg-white border-2 border-indigo-200 rounded-2xl shadow-lg space-y-4" id="concept-explanation-card">
          ...
          <div className="bg-slate-50 border border-slate-200 rounded-2xl p-8 text-center space-y-3">
            ...
            <button
              ...
              className="mt-2 px-4 py-2.5 bg-indigo-600 hover:bg-indigo-500 text-white text-xs font-bold rounded-xl shadow transition-all inline-flex items-center gap-1.5 cursor-pointer"
            >
      ...
      <div className="bg-white rounded-3xl p-6 sm:p-8 border border-slate-200/90 shadow-sm space-y-6" id="all-attempts-table-section">
        ...
        {attempts.length === 0 ? (
          <div className="text-center py-12 bg-slate-50 rounded-2xl border border-dashed border-slate-200 space-y-3">
            ...
            <button
              onClick={() => onNavigateToQuiz()}
              className="mt-2 px-4 py-2 bg-indigo-600 text-white text-xs font-bold rounded-xl hover:bg-indigo-500 transition-colors cursor-pointer"
            >
              Start First Quiz
            </button>
          </div>
                    ...
                    >
                      ...
                      <td className="py-3.5 px-4 text-right whitespace-nowrap">
                        <div className="flex items-center justify-end gap-2" onClick={e => e.stopPropagation()}>
                          <button
                            onClick={() => setSelectedAttempt(attempt)}
                            className="px-3 py-1.5 bg-indigo-50 hover:bg-indigo-100 text-indigo-700 font-bold rounded-lg transition-colors flex items-center gap-1 cursor-pointer"
      ...
      {selectedAttempt && (
        <div className="fixed inset-0 z-50 bg-slate-900/60 backdrop-blur-sm flex items-center justify-center p-4 sm:p-6 overflow-y-auto" id="attempt-details-modal">
          <div className="bg-white rounded-3xl max-w-3xl w-full max-h-[90vh] shadow-2xl border border-slate-200 overflow-hidden flex flex-col my-auto">
            ...
            <div className="p-4 bg-slate-50 border-t border-slate-200 flex flex-wrap items-center justify-between gap-3">
              <button
                ...
                className="px-4 py-2.5 text-xs font-semibold text-slate-700 hover:bg-slate-200 rounded-xl transition-colors flex items-center gap-1.5 cursor-pointer"
              >
                <BookOpen className="w-3.5 h-3.5" />
                Read Lesson Notes
              </button>
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="px-4 py-2.5 bg-indigo-600 hover:bg-indigo-500 text-white font-bold text-xs rounded-xl shadow transition-colors flex items-center gap-1.5 cursor-pointer"
                >
                ...
                <button
                  onClick={() => setSelectedAttempt(null)}
                  className="px-4 py-2.5 bg-slate-800 hover:bg-slate-700 text-white font-semibold text-xs rounded-xl transition-colors cursor-pointer"
                >
                  Close
                </button>
              </div>
